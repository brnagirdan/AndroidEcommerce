...
public class CartProductContract {
     ...
     * device.
     */
    public static final String CONTENT_AUTHORITY = "com.example.berna.cicekse2";
    ...
    public static final String PATH_PRODUCT = "product-path";
    ...
    public static final class ProductEntry implements BaseColumns {
        ...
        public final static String COLUMN_CART_KDV = "cartkdv";
        public final static String COLUMN_CART_PRICE = "cartprice";
        public final static String COLUMN_CART_NAME = "cartproductname";
